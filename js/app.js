...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h3>${product.title}</h3>
      <h4 style="color: yellow">Rating ${product.rating.rate} out of 5</h4>
...
const updateTaxAndCharge = () => {
  ...
  // APPLY CONDITION FOR COUNTING TAX
...
// LOAD API FUNCTION CALL HERE
loadProducts();


// BUY NOW BUTTON EVENT APPLY HERE
let buyNowBtn = document.getElementById("proccedToBuy");
// SUCCESS ALERT TAG 
...
buyNowBtn.addEventListener("click", function(){
   ...
   totalAmount = Number(totalAmount.innerText);
  if (totalAmount > 10 ) {
   successAlert.innerText = " Thank you, Your order is received!";
  }else{
       alert("Please Add Some Product To Add to Cart First!");
  }
